  ...
  return (
    <>
      ...
      >
        ...
        {/* Landing Card */}
        <div className="absolute bg-white/90 min-w-[350px] rounded w-[80%] md:w-[40%] h-[50%] p-5 border-1">
          ...
          <Link
            href="/pc-building"
            className="border-orange-500 bg-orange-500 text-white border px-3 py-2 rounded inline-block mr-5 mb-1 text-sm hover:bg-orange-500/90"
          >
            Start Building
          </Link>
          <Link
            href="/components"
            className="border-orange-500 px-3 py-2 rounded inline-block border text-sm hover:bg-orange-500/10"
          >
            Browse Components
          </Link>
        </div>
      ...
      <section className="m-20" id="featured">
        ...
        <div className="flex flex-col-reverse md:flex-row w-full h-200 md:h-125 justify-between border-1 rounded-2xl overflow-hidden">
          <div className="border-r-1 z-2 md:flex-1 p-5 md:min-w-[240px] bg-gray-50">
            ...
            <button className="mt-4 w-full px-4 py-2 bg-orange-500 text-white rounded hover:bg-orange-500/90 transition cursor-pointer">
              View Details
            </button>
          </div>
